//---------------------------------------------------------------------------
/****************************************************************************/
/* PLG_AUDIO_IO (C) 2008-2011 By 59414d41									*/
/*																			*/
/*																			*/
/****************************************************************************/
...
/* Function Prototype */
int PLG_InfoAudioData(LPSTR filename,SOUNDFMT *pFmt,DWORD *pAudioSize,FILEINFO *pFileinfo);
...
int PLG_GetExtraChunk(LPSTR filename,int nChunk,char **infoChunk,long *infoSize);
int PLG_GetChunkInfo(LPSTR filename,char *info,int infoSize);
