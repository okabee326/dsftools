...
echo -n '-s:88200 -w:24 -hfa:3 -hfc:15580 -adjBE -cutLowData -smLowData -overSamp:2 -thread:4 -deEmphasis:0 -postABE -sig1:1,4,-3 -sig2:1,-5 -sig3:1,-9 -hfaNB:0 -hfaWide -hfaDiffMin:1 -m:2 -n:0 -ditherLv:0 -ch:2 -dsf:0 -fio:200 ' > /tmp/tmpfile_upconv.param
